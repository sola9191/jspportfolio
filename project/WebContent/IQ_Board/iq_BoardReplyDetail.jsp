...
<div id="main">	
	<div class="container">
		...
		<div class="col-sm-6 text-center">
		<a href="${pageContext.request.contextPath}/list.consult" type="button" class="btn btn-default" id="mainbtn">1:1문의 답변확인</a>
		</div>
		</div>
	</div><!-- end container -->
<div id="detail">
	<div class="container">
		<form action="${pageContext.request.contextPath}/reply.consult?ino=${dto.ino}" method="post" id="reply_form">
			<fieldset>
			<table class="table">
				<tbody>
