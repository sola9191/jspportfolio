...
public class findPassAction1 implements CreAction {
	...
	public void execute(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		dto.setPphonenumber(request.getParameter("pphonenumber"));
		

		if(dao.findPasswithP(dto).getPpass()!=null) {
			
			request.setAttribute("tmppass", dao.findPasswithP(dto).getPpass());
