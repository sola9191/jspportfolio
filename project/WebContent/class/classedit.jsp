...
<div class="container"  style="margin-top:10%; min-height:500px">
		<form action="${pageContext.request.contextPath}/edit.class?classno=${cinfo.classno}" method="post"  id="edit_Form">
		   <fieldset>
		   <legend>강의수정</legend>
		   	<div class="form-group">
			  <label for="classcreator">작성자</label>
			  <input type="text"   name="classcreator"   id="classcreator" value="${cinfo.classcreator}" class="form-control" > 
			</div>	
			<div class="form-group">
			  <label for="classcateno">강의카테고리번호</label>
			   <input type="number"   name="classcateno"   id="classcateno"  value="${cinfo.classcateno}" class="form-control" min="1" max="7"> 
			</div>	
			<div class="form-group">
			  <label for="classcategory">강의카테고리</label>
			   <input type="text"   name="classcategory"   id="classcategory" value=""  class="form-control"  readonly> 
			</div>	
			<div class="form-group">
			  <label for="classname"  >강의명</label>
			  <input type="text"   name="classname"   id="classname" value="${cinfo.classname}"  class="form-control" > 
			</div>
			<div class="form-group">
			...
			<div class="form-group">
			  ...
			  <input type="text"   name="classprice"   id="classprice"   class="form-control" value="${cinfo.classprice}" > 
			</div>
			<div class="form-group">
			...
			<div class="form-group">
			  <label for="classcompo">강의구성</label>
			   <input type="text"   name="classcompo"   id="classcompo"   class="form-control" value="${cinfo.classcompo}"> 
			</div>	
			<div class="form-group">
			  <label for="classdetail">강의정보</label>
			  	<textarea name="classdetail"  id="classdetail"  cols="60"  rows="10"   class="form-control" >${cinfo.classdetail}</textarea>
			</div>
