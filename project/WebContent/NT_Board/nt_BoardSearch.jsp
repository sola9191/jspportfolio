		...
		<div class = "container">
			...
			<div class="container well" style="height:200px">
				...
				<div class="row r3 text-center">
					<div class="col-sm-12">
					<div id="r3">
						<a href="${pageContext.request.contextPath}/sort.service?ccategorynum=5" class="btn btn-default" id="btn5">회원/회원정보</a>
						<a href="${pageContext.request.contextPath}/sort.service?ccategorynum=6" class="btn btn-default" id="btn6">PC 원격지원</a>
						<a href="${pageContext.request.contextPath}/sort.service?ccategorynum=7" class="btn btn-default" id="btn7">오류문의</a>
						<a href="${pageContext.request.contextPath}/sort.service?ccategorynum=8" class="btn btn-default" id="btn8">기타</a>
					</div>
					</div>
				</div>
		</div><!--  end container -->
